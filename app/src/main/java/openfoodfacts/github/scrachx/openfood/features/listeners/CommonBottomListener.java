    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.compare_products:
                if (isCurrentActivity(ProductCompareActivity.class)) {
                    break;
                }
                currentActivity.startActivity((createIntent(ProductCompareActivity.class)));
                break;
            case R.id.home_page:
            case R.id.home:
            ...
            case R.id.history_bottom_nav:
                if (isCurrentActivity(ScanHistoryActivity.class)) {
                    break;
                }
                currentActivity.startActivity(createIntent(ScanHistoryActivity.class));
                break;
            case R.id.my_lists:
