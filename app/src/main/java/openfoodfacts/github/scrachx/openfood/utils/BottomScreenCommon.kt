...
object BottomScreenCommon {
    fun showBottomSheet(result: JsonNode?,
    ...
    private fun showBottomSheet(result: JsonNode?,
                                id: Long?,
                                name: String?,
                                searchType: SearchType,
                                fragmentTag: String,
                                fragmentManager: FragmentManager) {
        ProductAttributeFragment.newInstance(result, id!!, searchType, name)
