...
import openfoodfacts.github.scrachx.openfood.features.additives.adapter.AdditivesAdapter;
...
public class AdditiveListActivity extends BaseActivity implements AdditivesAdapter.ClickListener {
    ...
    public static void start(Context context) {
        Intent starter = new Intent(context, AdditiveListActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        asyncSessionAdditives.setListenerMainThread(operation -> {
            ...
            binding.additiveRecyclerView.setLayoutManager(new LinearLayoutManager(AdditiveListActivity.this));
            binding.additiveRecyclerView.setAdapter(new AdditivesAdapter(additives, AdditiveListActivity.this));
            binding.additiveRecyclerView.addItemDecoration(new DividerItemDecoration(AdditiveListActivity.this, DividerItemDecoration.VERTICAL));
        });
    ...
    public void onClick(int position, String name) {
        ProductSearchActivity.start(AdditiveListActivity.this, name, SearchType.ADDITIVE);
    }
        ...
        if (searchManager != null && searchManager.getSearchableInfo(this.getComponentName()) != null) {
            ...
            searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
                ...
                public boolean onQueryTextChange(String newText) {
                    ...
                    binding.additiveRecyclerView.setAdapter(new AdditivesAdapter(additiveNames, AdditiveListActivity.this));
