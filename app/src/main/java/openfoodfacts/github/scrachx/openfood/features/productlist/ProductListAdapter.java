...
public class ProductListAdapter extends RecyclerView.Adapter<ProductListAdapter.YourListProductsViewHolder> {
    private final boolean isLowBatteryMode;
    private final Context mContext;
    private final List<YourListedProduct> products;

    public ProductListAdapter(Context context, List<YourListedProduct> products, boolean isLowBatteryMode) {
