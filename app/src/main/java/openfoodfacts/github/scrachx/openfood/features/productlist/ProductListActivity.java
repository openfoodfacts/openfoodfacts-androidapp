...
public class ProductListActivity extends BaseActivity implements SwipeControllerActions {
    ...
    public static NotificationManager createNotification(File f, Intent downloadIntent, Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (products != null) {
            adapter = new ProductListAdapter(this, products, isLowBatteryMode);
            binding.rvYourListedProducts.setAdapter(adapter);

            SwipeController swipeController = new SwipeController(this, ProductListActivity.this);
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.CAMERA)) {
                new MaterialDialog.Builder(this)
                    ...
                    .onNeutral((dialog, which) ->
                        ActivityCompat.requestPermissions(ProductListActivity.this, new String[]{Manifest.permission.CAMERA}, Utils.MY_PERMISSIONS_REQUEST_CAMERA))
                    .show();
            } else {
                ActivityCompat.requestPermissions(ProductListActivity.this, new String[]{Manifest.permission.CAMERA}, Utils
    ...
    public void exportCSV() {
        ...
        try (CSVPrinter writer = new CSVPrinter(new FileWriter(f), CSVFormat.DEFAULT.withHeader(getResources().getStringArray(R.array.your_products_headers)))) {
            ...
            isDownload = false;
            Log.e(ProductListActivity.class.getSimpleName(), "exportCSV", e);
        }
