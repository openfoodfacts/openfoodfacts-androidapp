...
public class ScanHistoryActivity extends BaseActivity implements SwipeControllerActions {
    ...
    public static void start(Context context) {
        Intent starter = new Intent(context, ScanHistoryActivity.class);
    ...
    public void exportCSV() {
        ...
        try (CSVPrinter writer = new CSVPrinter(new FileWriter(csvFile), CSVFormat.DEFAULT.withHeader(getResources().getStringArray(R.array.headers)))) {
            ...
            Log.e(ScanHistoryActivity.class.getSimpleName(), "can export to " + csvFile, e);
        }

        Intent downloadIntent = new Intent(Intent.ACTION_VIEW);
        NotificationManager notificationManager = ProductListActivity.createNotification(csvFile, downloadIntent, this);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == Utils.MY_PERMISSIONS_REQUEST_STORAGE) {
            ...
            if (grantResults.length > 0 && grantResults[0] == PackageManager
                .PERMISSION_GRANTED) {
                Intent intent = new Intent(ScanHistoryActivity.this, ContinuousScanActivity.class);
    ...
    protected void onScanFirst() {
        ...
        if (Utils.isHardwareCameraInstalled(getBaseContext())) {
            if (ContextCompat.checkSelfPermission(getBaseContext(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                if (ActivityCompat.shouldShowRequestPermissionRationale(ScanHistoryActivity.this, Manifest.permission.CAMERA)) {
                    new MaterialDialog.Builder(this)
                        .title(R.string.action_about)
                        .content(R.string.permission_camera)
                        .neutralText(R.string.txtOk)
                        .onNeutral((dialog, which) -> ActivityCompat.requestPermissions(ScanHistoryActivity.this, new String[]{Manifest
                            .permission.CAMERA}, Utils.MY_PERMISSIONS_REQUEST_CAMERA))
                        .show();
                } else {
                    ActivityCompat.requestPermissions(ScanHistoryActivity.this, new String[]{Manifest.permission.CAMERA}, Utils
    ...
    private void fillView() {
        ...
        Log.i(ScanHistoryActivity.class.getSimpleName(), "task fillview started...");
        disposable = getFillViewCompletable().subscribe(() ->
            Log.i(ScanHistoryActivity.class.getSimpleName(), "task fillview ended"));
    }
    ...
    private Completable getFillViewCompletable() {
        ...
        final Function<List<HistoryProduct>, CompletableSource> updateUiFunc = historyProducts -> {
            ...
            adapter = new ScanHistoryAdapter(productItems, ScanHistoryActivity.this, isLowBatteryMode);
            binding.listHistoryScan.setAdapter(adapter);
            binding.listHistoryScan.setLayoutManager(new LinearLayoutManager(ScanHistoryActivity.this));
            binding.historyProgressbar.setVisibility(View.GONE);

            SwipeController swipeController = new SwipeController(ScanHistoryActivity.this, ScanHistoryActivity.this);
