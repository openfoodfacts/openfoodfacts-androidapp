 ...
 */
public class ProductEditPhotosFragment extends BaseFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        photoReceiverHandler = new PhotoReceiverHandler(newPhotoFile -> {
            ...
            if (activity instanceof ProductEditActivity) {
                ((ProductEditActivity) activity).addToPhotoMap(image, 4);
            }
        });
        ...
        if (b != null) {
            ...
            boolean editionMode = b.getBoolean(ProductEditActivity.KEY_IS_EDITING);
            if (product != null) {
    ...
    private void addImageRow() {
        ...
        TableRow.LayoutParams lp = new TableRow.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, Utils.dpsToPixel(100, getActivity()));
        lp.topMargin = Utils.dpsToPixel(10, getActivity());
        ImageView imageView = new ImageView(activity);
        Picasso.get()
            .load(photoFile)
            .resize(Utils.dpsToPixel(100, getActivity()), Utils.dpsToPixel(100, getActivity()))
            .centerInside()
            .into(imageView);
