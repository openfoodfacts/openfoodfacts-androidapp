...
public class Country implements TaxonomyEntity {
    ...
    @Keep
    public Country(String tag, List<CountryName> names, String cc2, String cc3) {
        this.tag = tag;
        this.names = names;
        this.cc2 = cc2;
        this.cc3 = cc3;
    ...
    @Generated(hash = 1635152172)
    public Country(Long id, String tag, String cc2, String cc3) {
        this.id = id;
        this.tag = tag;
        this.cc2 = cc2;
        this.cc3 = cc3;
